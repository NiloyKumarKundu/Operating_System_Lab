...
echo "List of the Nearby Wifi...";


# Scan Wifi
systemctl start NetworkManager;
nmcli dev wifi >> scan.txt;

cat scan.txt;

# Cut Channel
cut -c 54-55 scan.txt >> channel.txt;




# Read Channels and output
